...
# ==============================================================================
# 검출 과정 핵심 흐름
# -> 진입점과 플래그 : train_object_detector.py
# -> 앵커/클래스/임계치 설정 : kitti_config.py
# -> 모델 헤드와 박스 처리 : mobilenetdet.py
# -> 로스/디코딩/NMS : det_utils.py
# -> 전처리/데이터셋 : mobilenet_preprocessing.py, kitti.py
# ==============================================================================
